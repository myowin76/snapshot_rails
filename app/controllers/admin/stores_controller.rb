class Admin::StoresController < Admin::AdminController
  ...
  private
    ...
    def admin_store_params
      params.require(:admin_store).permit(:name, :address, :address2, :address3, :town, :postcode, :store_format_id, :retailer_id, :country_id, :environment_type_id, :channel_id, :longitude, :latitude, :description)
    end
end
