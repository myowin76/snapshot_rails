...
class Admin::PhotosControllerTest < ActionController::TestCase
  ...
  test "should create admin_photo" do
    assert_difference('Admin::Photo.count') do
      post :create, admin_photo: { audit_id: @admin_photo.audit_id, headline: @admin_photo.headline, published: @admin_photo.published }
    end
  ...
  test "should update admin_photo" do
    patch :update, id: @admin_photo, admin_photo: { audit_id: @admin_photo.audit_id, headline: @admin_photo.headline, published: @admin_photo.published }
    assert_redirected_to admin_photo_path(assigns(:admin_photo))
  end
